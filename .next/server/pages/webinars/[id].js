...
async function getServerSideProps(context) {
    ...
    const res = await fetch(`${_config_json__WEBPACK_IMPORTED_MODULE_2__/* .SERVER_URL */ .LB}webinars?_embed&slug=${id}`);
...
var __webpack_exports__ = __webpack_require__.X(0, [9210,3573,3121,676,3061,4580,2848], () => (__webpack_exec__(4943)));
