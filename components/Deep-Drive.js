        ...
        <Row className="gap-4">
          <Col>
            <Card className="border-0">
              ...
              <Card.Body>
                <Card.Title style={{ height: '100' + 'px' }}>
                  The Bank of 20XX: Navigating Uncharted Waters
                </Card.Title>
                <Button variant="primary" className="deep-btn">
                  Download Whitepaper
                </Button>
              </Card.Body>
            </Card>
          ...
          <Col>
            <Card className="border-0">
              ...
              <Card.Body>
                <Card.Title style={{ height: '100' + 'px' }}>
                  The Power of Options and Choices – A Definitive View on
          ...
          <Col>
            <Card className="border-0">
              ...
              <Card.Body>
                <Card.Title style={{ height: '100' + 'px' }}>
                  How Can Banks Move Beyond Transactional Relations to Build
