...
function LinksExample() {
  return (
    <>
      <Link href="/request-a-demo" className="demo">
        Request a Demo
      </Link>
        ...
        <Row>
          <Col sm={6} lg={3} xs={6} md={6}>
            ...
            <ul className="text-white list-inline">
              <li>
                <Link href="/enterprise-product-management">
                  Enterprise Product Management
                </Link>
              </li>
              <li>
                <Link href="/dynamic-offer-management">
                  Dynamic Offer Management
                </Link>
              </li>
              <li>
                <Link href="/deal-management">Deal Management</Link>
              </li>
              <li>
                <Link href="/relationship-based-pricing-management">
                  Relationship-Based Pricing Management
                </Link>
              </li>
              <li>
                <Link href="/enterprise-billing-and-statements-management">
                  Enterprise Billing and Statements Management
                </Link>
              </li>
              <li>
                <Link href="/ecosystem-management-and-monetization">
                  Ecosystem Management and Monetisation
                </Link>
              </li>
              <li>
                <Link href="/benefits-and-loyalty-management">
                  Benefits and Loyalty Management
                </Link>
              </li>
              <li>
                <Link href="/enterprise-indirect-taxation-management">
          ...
          <Col sm={6} lg={3} md={6} xs={6}>
            ...
            <ul className="text-white list-inline">
              ...
              <li>
                <Link href="/suntec-banking-as-a-service-solution">
                  Banking-as-a-Service
                </Link>
              </li>
              <li>
                <Link href="/product-rationalization">
                  Product Rationalization
                </Link>
              </li>
              <li>
                <Link href="/suntec-vat">VAT for GCC</Link>
              </li>
              <li>
                <Link href="/suntec-negative-interest-management">
                  Negative Interest Management
                </Link>
              </li>
              <li>
                <Link href="/invoicing-solution-for-swedish-banks">
                  Invoicing Solution for Swedish Banks
                </Link>
              </li>
              <li>
                <Link href="/suntec-e-invoicing">
                  e-Invoicing Solution for KSA
                </Link>
              </li>
              <li>
                <Link href="/credit-card-solutions">Credit Card Solution</Link>
              </li>
              <li>
                <Link href="/accelerate-your-banks-progress-on-its-esg-journey-with-the-suntec-esg-solution">
                  ESG Solution
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/personalization">Packages and Bundles</Link>
              </li>
            </ul>
          </Col>
          <Col sm={6} lg={2} xs={6} md={6}>
          ...
          <Col sm={6} lg={2} xs={6} md={6}>
            ...
            <ul className="text-white list-inline">
              ...
              <li>
                <Link href="/blogs/suntecs-strategic-response-to-covid-19">
                  Covid Response
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/hr-initiative">HR Initiative</Link>
              </li>
              <li>
                <Link href="/news-room">Newsroom</Link>
              </li>
              <li>
          ...
          <Col lg={3} sm={6} xs={6} className="d-lg-none d-xl-none">
            ...
            <ul className="text-white list-inline">
              <li>
                <Link href="/suntec-xelerate">Xelerate</Link>
              </li>
              <li>
                <Link href="/suntec-cloud">Cloud</Link>
              </li>
              <li>
                <Link href="/suntec-saas">Saas</Link>
              </li>
            </ul>
          </Col>
      ...
      >
        <Row>
          <Col className="center fs-5 fw-bold d-flex justify-content-end">
            Follow us
          </Col>
          <Col>
      ...
      <Container className="wbg-black p-3" fluid>
        ...
        <p className="text-white">
          SunTec® and Xelerate® are registered trademarks of SunTec Business
          Solutions.
        </p>
      </Container>
    </>
