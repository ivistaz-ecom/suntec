  ...
  return (
    <Container className="r_content text-center p-3 mt-4 mb-3 pb-5" fluid>
      ...
      <OwlCarousel
        ...
        {...options}
      >
        <div class="item bg-review" style={{ background: '#ff000000' }}></div>
        <div class="item bg-review">
          ...
          <div className="t_bg">
            ...
            <p>
              Here at SunTec, we have a key role to play, and our voice is
              heard.”
            </p>
          </div>
        </div>
        <div class="item bg-review">
          ...
          <div className="t_bg">
            ...
            <p>
              “If you have a mindset to learn new things, you can excel in
              whatever you do.”
            </p>
          </div>
        </div>
