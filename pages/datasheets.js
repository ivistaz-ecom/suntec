          ...
          <Col sm={11} xs={11} lg={4}>
            <div className="r-text">
              ...
              <div className="wbg-gr p-2 w-text">
                ...
                <p className="fs-5">
                  We have a lot to say, unravel our product offerings from
                  below!
                </p>
              </div>
            </div>
      ...
      <Container className="mt-5 ">
        ...
        <Row>
          {movies.map((post, index) => {
            //console.log(post);
            return (
              <Col sm={4} md={6} xl={4} className="p-3" key={post.id}>
                <Card style={{ height: 15 + 'em' }}>
                  <Card.Body>
                    <Card.Title
                      className="fs-5 mb-5"
                      style={{ height: 1 + 'em' }}
                    ...
                    />
                    <Link
                      href={post['acf']['pdf_file']}
                      className="b-btn btn text-white"
                      target="_blank"
                    >
                      Datasheet
                    </Link>
