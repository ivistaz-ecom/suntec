        ...
        <Row>
          <Col lg={5} xs={12} sm={12} md={6}>
            <div className="b-text">
              ...
              <p>
                Automate end-to-end deal management process, provide flexibility
                to create customer-specific deals, mitigate conduct risk and
                reduce revenue leakage while ensuring price transparency and
                policy compliance.
              </p>
      ...
      <Container>
        <Row className="d-flex flex-column flex-lg-row mt-5 mb-5">
          ...
          <Col lg={5} sm={12} className="m-2">
            ...
            <p className="fs-5">
              SunTec’s Deal Management software on the SunTec Xelerate platform
              enables financial services, telecom, travel and insurance firms to
              manage the sales process from the construction of the proposal
              through to the negotiation and closure of the deal. It enables
              organizations to streamline and automate the process by bringing
              the required transparency and measurability. SunTec’s Deal
              Management ensures a data-driven deal process that enhances
              transparency and sales forecasting. It significantly improves the
              sales process, simplifies complex negotiations, improves the
              quality of revenue, and streamlines downstream billing operations.
            </p>
          </Col>
        </Row>
      </Container>
          ...
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Enables the creation of specific, choice-driven deals for each
                  customer
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Centralized capability to manage complex cross-product and
                  cross-entity deals
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col lg={4} md={12}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Simulate expected revenue and profits based on throughputs and
                  price points to drive negotiations
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Fully automated workflow and notifications as well as
                  multi-level, sequential and parallel approvals
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Intelligent UX based on persona allows ease of use and
          ...
          <Col lg={4} md={12}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Automated implementation of the deal ensures synchronization
                  with downstream pricing and billing systems
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
        ...
        <Row className="d-flex flex-lg-row flex-column">
          ...
          <Col>
            <h3 className="text-white fs-4">
              &quot;Ensure organizational profitability by plugging revenue
              leakage effectively&quot;
            </h3>
            <p className="text-white fs-5">
              Roll out contextual offers in real time with SunTec&apos;s Dynamic
              Offer Management
            </p>
            <ul className="mt-5">
              <li className="text-white fs-6">
                <strong>A de-cluttered view of deals:</strong> Manage deals
                across territories and obtain a comprehensive view of every
                deal, irrespective of multi-entity and multi-geography
                structures of customer enterprises.
              </li>
              <li className="text-white fs-6">
                <strong>Revenue monitoring made easy:</strong> Perform a
                cost-benefit analysis of deals and monitor revenue through
                commitment and deal performance tracking.
              </li>
            </ul>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Mitigate conduct risk and promote fairness by right pricing
          ...
          <Col sm={12} lg={4} xs={12} md={12}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Reduce cost through automation of the end-to-end process
                  including deal implementation
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
        ...
        <Row>
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Drive overall relationship value through cross-bundle offers
                  and benefits
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Enhance the sales process by providing the right insights for
          ...
          <Col sm={12} lg={4} xs={12} md={12}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Reduce operational risks and improve controls through
                  conditional approvals and centralization of the entire process
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
