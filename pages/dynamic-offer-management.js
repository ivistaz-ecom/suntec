    ...
    <>
        ...
        <Row>
          <Col lg={5} xs={12} sm={12} md={6}>
            <div className="b-text">
              ...
              <p>
                Grow and enrich your customer relationships by quickly launching
                highly personalized, contextual offers.
              </p>
      ...
      <Container>
        <Row className="d-flex flex-column flex-lg-row mt-5 mb-5">
          ...
          <Col lg={5} sm={12} className="m-2">
            ...
            <p className="fs-5">
              SunTec&apos;s Dynamic Offer Management on SunTec Xelerate platform
              is a digital innovation middle layer that can easily integrate
              with the bank&apos;s existing technology landscape and provide a
              highly configurable offer management capability that enables
              customer choice, enhances customer relationships, reduces time and
              cost to market and propels growth through up-sell and cross-sell
              capabilities.
            </p>
          </Col>
        </Row>
      ...
      <Container className="mb-5">
        <h1 className="fs-2 mt-5 mb-5">
          Features of SunTec&apos;s Dynamic Offer Management
        </h1>
        <Row>
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Creation and provision of the right offers to each customer
                  based on their choice and need
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Product, Bundle, Service and Benefit Offers for individual
                  customers, accounts and dynamic sub segments
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={4} md={12}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Exhaustive and rule-driven qualification and eligibility
                  criteria drive personalized and contextual application of
                  offers
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Quick offer roll-out and offer switching and periodic review
                  and expiry management ensure the right portfolio of offers
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Easy creation and management of offers with intuitive UX for
                  different personas
                </Card.Text>
              </Card.Body>
            </Card>
        ...
        <Row className="d-flex flex-lg-row flex-column">
          ...
          <Col>
            <h3 className="text-white fs-4">
              &quot;Enable customer centricity with the right solution to each
              customer&apos;s context and need&quot;
            </h3>
            ...
            <ul className="mt-5">
              <li className="text-white fs-6">
                <strong>Offer orchestration like never before:</strong> Manage
                the entire offer development lifecycle in real time, from offer
                ideation via real-time customer transaction tracking, to
                simulation and testing, and finally offer fulfilment and
                tracking.
              </li>
              <li className="text-white fs-6">
                <strong>Roll out offers in real time:</strong>Get an insight
                into customer behavior to roll out the right offers rapidly,
                thereby enhancing customer engagement and customer lifetime
                value and eliminating revenue leakage.
              </li>
            </ul>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Reduce time and cost to market of specific offers and
                  campaigns
                </Card.Text>
              </Card.Body>
            </Card>
        ...
        <Row>
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Improve quality of revenue through automated management of
                  offers including enrolment/de-enrolment
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Improve offer quality and breadth by co-innovating with third
                  party partners
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col sm={12} lg={4} xs={12} md={12}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Empower front end staff to service customers through specific
        ...
        <Row>
          <Col sm={12} lg={4} xs={12} md={12}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Reduce operational and revenue risk through end-to-end
                  automation
                </Card.Text>
              </Card.Body>
            </Card>
