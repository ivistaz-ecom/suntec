    ...
    <>
        ...
        <Row>
          <Col lg={5} xs={12} sm={12} md={6}>
            <div className="b-text">
              ...
              <p>
                Establish customer choice at the heart of your enterprise and
                enable right selling through the creation of an enterprise
                master catalog for all products and services.
              </p>
        ...
        <Row className="d-flex flex-column flex-lg-row mt-5 mb-5">
          ...
          <Col lg={5} sm={12} className="m-2">
            ...
            <p className="fs-5">
              ...
              platform enables a single source of truth for all products and
              services for the financial services, telecom, travel and insurance
              sectors. Combined with an end-to-end life cycle management view,
              this master catalog enables managing of personalized products,
              including both internal and external partner products. It helps
              prevent wrong selling through enhanced controls and enables
              product convergence. SunTec&apos;s Xelerate platform gives the
              flexibility to define any product or service across all lines of
              business. SunTec Xelerate further provides comprehensive
              traceability across the product life cycle and improves time and
              cost to market significantly.
            </p>
          </Col>
        </Row>
      </Container>
      ...
      <Container className="mb-5">
        <h1 className="fs-2 mt-5 mb-5">
          Features of SunTec&apos;s Enterprise Product Management
        </h1>
        <Row>
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Agile and configurable product creation through an extremely
          ...
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Contextual, customer choice driven, and relationship-based
                  selling of products and services enabled by rules
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={4} md={12}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Create a centralized, enterprise master for products and
                  services across all lines of businesses
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Use prebuilt product templates in system or define your own
                  templates with ease
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col lg={4} md={6}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Rich set of configurable rules to fine tune product&apos;s
                  business behaviour based on context
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={4} md={12}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Holistic capability managing internal products as well as
          ...
          <Col lg={4} md={12}>
            <Card className="c_shadow" style={{ height: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Monitor and track progress of the products through its
                  different life stages from ideation to expiry
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={4} md={12}>
            <Card className="c_shadow" style={{ minHeight: 18 + 'em' }}>
              ...
              <Card.Body className="c_body">
                ...
                <Card.Text>
                  Well documented APIs allows for easy integration with other
                  systems
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col>
            ...
            <ul className="mt-5">
              ...
              <li className="text-white fs-6">
                ...
                organization&apos;s ecosystem with our extensive set of APIs.
              </li>
            </ul>
          </Col>
        </Row>
        ...
        <Row>
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Reduce time to market through a configurable, template driven
                  framework
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Create competitive differentiation by quick launch of
                  differentiated offers to dynamic sub-segments
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col sm={12} lg={4} xs={12} md={12}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Standardize the products and services being offered in the
                  market through a centralized catalog
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
        ...
        <Row>
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Personalize and contextualize the products to each customer
                  based on context and the choice of the customer
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Enhance choice to customers by mastering partner products and
          ...
          <Col sm={12} lg={4} xs={12} md={12}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Improve quality of revenue through insight-driven life cycle
        ...
        <Row>
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Prevent product proliferation through a rule-based framework
                  that drive contextual behaviour of products
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col sm={12} lg={4} xs={12} md={6}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Prevent revenue leakage by the establishment of a single
                  source of truth for all parts of the process, from selling to
                  billing
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col sm={12} lg={4} xs={12} md={12}>
            <Card className="c_shadow" style={{ height: 16 + 'em' }}>
              ...
              <Card.Body className="c_body">
                <Card.Text>
                  Enable regulatory compliance with traceability and end-to-end
      ...
      <CallCta
        text="Know your customers better and deliver hyper personalized offerings with SunTec."
