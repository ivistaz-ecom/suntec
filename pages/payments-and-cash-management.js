...
function productRationalization() {
  ...
  const bgImage = {
    ...
    backgroundImage: `url('/images/challenges_in_global_img.png')`,
    ...
    <>
      ...
      <Container className="p-3 b-banner" fluid style={{
        ...
        <Row className='h-100 align-items-center '>
          <Col  sm={6} className='d-flex align-content-center  justify-content-center' >
      ...
      <Container className='my-5'>
        <Row className='position-relative d-flex flex-lg-row flex-column-reverse'>
          {/* column 1 */}
          <Col sm={12} md={6} className='flex-column h-100' style={{}}>
            <Image src='/images/challenges_in_global_img.png ' alt='' className='img-fluid' />

            <div className='d-flex d-lg-none  justify-content-end '>
            <div className="card border-0  card-p rounded-0 col-md-9 bottom-95 " >
              <div className="card-body wbg-green">
                <h5 className="card-title fs-2 txt-suntec txt-dark-green ">Global businesses are increasingly turning to banks for solutions to respond to their cash management challenges:</h5>
                <ul className='fs-6 '>
                  <li className=''>Getting real-time visibility into cash balances</li>
         ...
         {/* column 2 */}
          <Col sm={12} md={6} >
            <div className='p-3 '>
              <h3 className='fs-2 txt-dark-purple '>Challenges in Global Payments and Cash Management</h3>
          ...
          <div className='d-lg-flex d-none  justify-content-end '>
            <div className="card border-0  card-p rounded-0 position-absolute col-md-9 bottom-95 " >
              <div className="card-body wbg-green">
                <h5 className="card-title fs-2 txt-suntec txt-dark-green ">Global businesses are increasingly turning to banks for solutions to respond to their cash management challenges:</h5>
                <ul className='fs-6 '>
                  <li className=''>Getting real-time visibility into cash balances</li>
      ...
      <Container className='py-5'>
        <Row className='d-flex flex-lg-row flex-column-reverse'>
          ...
          <Col sm={6} md={6} className=''>
            <Image src="/images/enable_superior_img.png" className='w-100 h-100' />
          </Col>
        </Row>
      </Container>
      ...
      <Container>
        ...
        <div class="card border-0 card-g wbg-green rounded-0 col-md-12" >
          <div class="card-body">
            <h5 class="card-title fs-1 ">Key Benefits</h5>
      ...
      <Container fluid className='g-0 py-5'>
        <Image src="images/interested_above_img-1.png" className='w-100 ' />
      </Container>

      <Container className='linear py-5' fluid>
        <Container className="border border-2">
          <h1 className='fs-1  text-center py-3 txt-dark-purple'>Interested in Taking the Next Step?</h1>
          <Container className='card py-4 rounded-0 border-0'>
            <h2 className='fs-2 txt-dark-purple'>Streamlining Payments and Cash Management – A Guide to Transform Your Offer-to-Bill Lifecycle</h2>
