    ...
    <>
      ...
      <Container className='mt-5'>
        ...
        <Row className='mt-5'>
          ...
          <Col>
            <Card className="rounded-0 shadow" style={{ height: 40 + 'em' }}>
              ...
              <Link href="/enterprise-product-management" className='expand-btn'>Learn more</Link>
            </Card>
          </Col>
          ...
          <Col>
            <Card className="rounded-0 shadow" style={{ height: 40 + 'em' }}>
              ...
              <Link href="/dynamic-offer-management" className='expand-btn'>Learn more</Link>
            </Card>
          </Col>
          ...
          <Col>
            <Card className="rounded-0 shadow" style={{ height: 40 + 'em' }}>
              ...
              <Link href="/deal-management" className='expand-btn'>Learn more</Link>
            </Card>
          </Col>
        </Row>
        ...
        <Row className='mt-5'>
          ...
          <Col lg={4}>
            <Card className="rounded-0 shadow" style={{ height: 40 + 'em' }}>
              ...
              <Link href="/relationship-based-pricing-management" className='expand-btn'>Learn more</Link>
            </Card>
          </Col>
          <Col lg={4}>
            <Card className="rounded-0 shadow" style={{ height: 40 + 'em' }}>
              ...
              <Link href="/enterprise-billing-and-statements-management" className='expand-btn'>Learn more</Link>
            </Card>
          </Col>
          <Col lg={4}>
            <Card className="rounded-0 shadow" style={{ height: 40 + 'em' }}>
              ...
              <Link href="/ecosystem-management-and-monetization" className='expand-btn'>Learn more</Link>
            </Card>
          </Col>
        </Row>
        ...
        <Row className='mt-5'>
          <Col lg={4}>
            <Card className="rounded-0 shadow" style={{ height: 40 + 'em' }}>
              ...
              <Link href="/benefits-and-loyalty-management" className='expand-btn'>Learn more</Link>
            </Card>
          </Col>
          <Col lg={4}>
            <Card className="rounded-0 shadow" style={{ height: 40 + 'em' }}>
              ...
              <Link href="/enterprise-indirect-taxation-management" className='expand-btn'>Learn more</Link>
            </Card>
          </Col>
        </Row>
