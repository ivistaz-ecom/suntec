...
<Container className="p-md-3 pe-banner"  style={{ 
...
<p className="fs-5">Banking-as-a-Service (BaaS) helps bring personalized, 
customer-centric offerings to market faster. Banks can expand their footprint 
and connect with new demographics to solve broader lifecycle needs and evolve 
into the ‘everyday bank and customer owner’ by collaborating with a host of partners. 
BaaS can enhance customer loyalty and create new revenue streams with a robust
 ecosystem management and monetization platform. The model allows banks to focus on 
 their strengths and minimize gaps in customer satisfaction for future growth.</p>
    <p className="fs-5">As BaaS matures and evolves further, there is a need for robust 
    technology platforms that can integrate digital banking ecosystems and work with:</p>
   <ul><li className="fs-5">Providers: who give access to core elements of the banking 
     product and operations stack</li>
    <li className="fs-5">Enablers: who unify the disparate elements into usable solutions</li>
      <li className="fs-5">Distributors: who take the solution to the customers via 
       proprietary customer channels</li>
     </ul>
</div>
</Col> 
</Row>
...
<Container className="py-5 p-md-5 p-sm-2"   style={{background:'#F3E7EF'}}>
...
<h2 className='px-5'>Key Capabilities</h2>
<p className="fs-5 px-5">SunTec Xelerate seamlessly manages foundational factors for BaaS Models:</p>
        <Row className="pb-5">
          <Col lg={8} sm={12} className="d-flex flex-column justify-content-center px-5">
            <h2>1. Manage</h2>
...
<Container  style={{background:'#F1E4F2'}} className="pb-5 pt-5 mb-5 ">
 <h2 className="pb-4 px-5">Business Benefits</h2>       
 <Row>  
<Col sm={6} >
<Card className="d-flex flex-row c-height px-5" style={{backgroundColor:'#F1E4F2'}}>
...
<Container className="wbg-gy mt-5 pb-5 pt-5 px-5 ">        
<h2 className="pb-3 px-3">Products That Enable this Solution</h2>
<Row>  
          <Col sm={6} >
            <ShortCard title="Ecosystem Management and Monetization" img="images/2.png"/>
</Col>
          <Col sm={6}>
          <ShortCard title="Relationship-based Pricing Management" img="images/4.png"/>
</Col>   
</Row>
<Row>  
          <Col sm={6}>
          ...
          <Col sm={6}>
          <ShortCard title="Enterprise Billing and Statements Management" img="images/1.png"/>
...
<h1 className="fs-2 mt-5 mb-5 d-flex flex-lg-row justify content center">Related Resources</h1>
<Row>
<Col>
...
<Col sm={6} lg={8} className="d-flex">
