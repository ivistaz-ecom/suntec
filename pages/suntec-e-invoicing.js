    ...
    <>
        ...
        <Row>
          ...
          <Col lg={6}>
            <div className="pt-text" >
              ...
              <ul><li className="fs-5">All taxpayers subject to value-added tax residing in KSA; and</li>
                <li className="fs-5">Any party that issues a tax invoice on behalf of a taxpayer who is subject to VAT.</li>
              </ul>
          ...
          <Row >
            ...
            <Col sm={12} lg={4}>
              <div class="card border-0 wbg-gy" style={{ background: '#f4f4f4' }} >
                ...
                <div class="card-body text-center">
                  <h5 class="card-title fw-bold">Compliance with e-invoice and <Link href="/press_release/suntec-introduces-a-fully-pre-configured-e-invoicing-solution-to-help-banks-in-the-kingdom-of-saudi-arabia-comply-with-regulations/"><span className='txt-dark-purple'>VAT regulations of KSA</span></Link></h5>
      ...
      <Container className='wbg-gy p-5'>
        <div className=''>
           ...
           <Button href="request-a-demo/" target='_blank' className='rounded-1 b-btn w-25 mb-3'>Accelerate with SunTec Xelerate</Button>
           </div></div>
           </Container>
